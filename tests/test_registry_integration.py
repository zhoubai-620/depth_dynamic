...
def test_submodule_imports():
    ...
    modules = [
        ...
        ("extreme_avoid.perception.fused_backbone", "LightweightIlluminationPrompter"),
        ("extreme_avoid.perception.fused_backbone", "LightweightViewPrompter"),
        ("extreme_avoid.perception.fused_backbone", "SimpleFusionBlock"),
